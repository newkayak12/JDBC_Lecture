...
public class MemberView {
	...
	public void printData( List<Member> temp)	{
	...
	public void printData(int update, String state) {
		if(update != 0) {
			
			System.out.println(update + " 행이 "+state+"되었습니다.");
			
		} else {
			
			System.out.println("항목이 "+state+"되지 않았습니다.");
	...
	public String[] update() {
		...
		int choice = scn.nextInt();
			...
			String[] result = { checkId, pointer, modification };
